    ...
    <NavBar textColor={"white"} textColor2={"yellow"} textColor3={"white"} textColor4={"white"}/>
        <div className={style.mainContainer}>
            ...
            <div className={style.bookContainer}>
                ...
                <p>
                    Omeiheukwu: The One Who Does Extraordinary Things is a highly uplifting account of a loved one who has passed. A glorious tribute to a man who brought color to so many lives. With exquisite tunefulness and compelling simplicity that is, at times, deeply moving, and at times, refreshingly amusing, Quincy Alagbu weaves together a personal story inspired by his beloved grandfather who entered eternal rest on September 21, 2021.
                    In this punchy masterpiece, Quincy Alagbu proves, with profound wisdom, that there truly are people who bring a special kind of light into this world—a light so wondrous that even after they are gone, it never stops dazzling.
                    Omeiheukwu: The One Who Does Extraordinary Things, with its stirring messages, is hands down a must-feel. A work you will not only read but also share!
                </p>

                <div className={style.authorInfo}>
                    <img src={pht} alt="Quincy Alagbu" className={style.authorImage}/>
                    <p>Quincy Alagbu explores the profound impact of his grandfather's legacy in this touching narrative.
                        His storytelling captures the essence of cherished memories and the lasting influence they have.</p>
                </div>

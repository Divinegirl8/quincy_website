...
import blog from "../../assests/blogImg/blog.jpeg";
const Blog = () =>{
    return(
        <>
            ...
            <div className={style.blogCont}>
                ...
                <div className={style.pCont}>
                    ...
                    <p>With one knee bent, he said, "I am."</p>
                    <p>And with legs up, he said, "New and different."</p>
                    <p>Then he grabbed the door and slammed it against the figure.</p>
                    <p>Thunder started to rage as if provoked again.</p>
                    <p>"I'll be back!" the figure roared. </p>
                    <p>"And I'll be ready!" Obi fired back.</p>
                    <p>*</p>
                    <p>Fiction?</p>
                    <p>Yes.</p>
                    ...
                    <p>And you have to be ready. The best way to get through them is to be prepared for any situation that may be hurled your way.</p>
                    <p>I know if some of us had a choice, we would probably seek to avoid challenges.</p>
                    <p>However, despite one's best effort to avoid them, challenges arise and threaten one's journey. Thus, one must handle them.</p>
                    <p>It is best to be prepared for road bumps because you're bound to hit them from time to time as you go through life.</p>
                    <p>Don't arrive at a level in your life and get too comfortable with it. Besides, there is comfort in discomfort.</p>
                    <p>Yes.</p>
                    <p>And growth starts with a decision to move beyond your present circumstances.</p>
                    <p>"When things do not go your way, remember that every challenge — every adversity — contains within it the seeds of opportunity and growth." ― Roy T. Bennett.</p>
                    <p>A challenge only becomes an [absolute] obstacle when you bow to it.</p>
                    <p>Start that fire and keep it burning.</p>
                    <p>Have a high-yielding week!</p>
                    <h4>© Quincy Alagbu</h4>
